...
### Documentation Pass: Combat Battlefield Layout v1

Implemented:

- Locked `COMBAT_BATTLEFIELD_LAYOUT_V1` as the formal battlefield ratio rule for future chapter battle backgrounds.
- Recorded Landmark, Boss Anchor, Enemy Formation, Combat Focus Zone, Player Formation, UI Safe Area, and Corridor Axis ratio rules.
- Added the S1 Kingdom Border Battlefield Layout Refinement image as a temporary calibration reference.

Protected:

- Did not redesign Player Formation, Enemy Formation, Boss, or Summon coordinates.
- Did not modify combat system logic, targeting, Skill Queue, Battle Log, bottom UI, damage, status effects, or encounter behavior.
- The reference background is calibration-only and is not final runtime art.

## 2026-06-16

### Validation Pass: BattleScene V4 Layout

Implemented:

- Added a `ChapterLandmarkZone` node to the BattleArea upper-left reserved background area.
- Rebuilt default BattleScene player and enemy slot coordinates around Corridor Composition.
- Added dynamic player formation layout for Solo, Duo, Trio, and Full Party.
- Added dynamic enemy formation layout for 1 through 6 enemies.
- Added independent Boss positioning near the battle centerline.
- Temporarily moved `SummonReserveSlots` to the battlefield center area at `(214, 472)`.
- Adjusted player formation coordinates lower while preserving the V4 slight clockwise corridor read.

Protected:

- Did not modify combat system logic, targeting, Skill Queue logic, damage logic, status effects, Battle Log, Loot Log, Story Log, Skill/Gear/Team/Menu, Expedition, Hub Tavern, or World Map behavior.
- Did not change reserve/support button behavior; only its temporary battlefield position changed.

### Documentation Pass: Battlefield Visual Rule v4

Implemented:

- Added `COMBAT_BATTLEFIELD_VISUAL_RULE_V4` to the finalized combat documentation.
- Recorded Corridor Composition, diagonal confrontation readability, opposing 5～8 degree formation rotation, Boss-centered enemy formation, horizontal centered Combat Focus Zone, and Chapter Landmark Zone exclusion rules.

Protected:

- Did not change scenes, scripts, combat pacing, damage values, Skill Queue, Boss focus, Target Line logic, or single-layer battlefield rules.

Verification:

- Documentation-only update; Godot startup was not run.
...
## 2026-06-14 Workshop Database Chapter 01 Draft

### Added

- Added `WORKSHOP_DATABASE_CH01.md` as the Chapter 01 / 王國邊境 Workshop Database draft.
- Added Chapter 01 semi-finished material, civilization material, accessory, and potion workshop entries.
- Added Broken Equipment Reference entries from `BROKEN_EQUIPMENT_DATABASE.md`.
- Marked `狼王獠牙護符（殘缺）` as a Blacksmith purple-equipment route for `狼王獠牙項鍊` instead of a Workshop recipe.

### Protected

- Did not modify `WORKSHOP_CURRENT.md`.
- Did not modify `monster_material_master_database.md`.
- Did not add new monster material names.
- Did not add weapon, armor, blue equipment, purple equipment, or Boss dark-gold equipment recipes to Workshop.
- Did not modify Godot scenes or scripts.

## 2026-06-14 Equipment CBT Stat Planning Scope

### Added

- Updated `EQUIPMENT_CURRENT.md` with the CBT equipment stat-planning boundary.
- Locked equipment stat planning to Chapter 01 through Chapter 05 only during CBT design.
- Recorded that unopened chapters must not receive reserved equipment values, multipliers, or growth curves.
- Recorded that Chapter 06+ equipment scaling must be re-evaluated only when those chapters become formal-version scope.

### Protected

- Did not modify `WORKSHOP_CURRENT.md`.
- Did not modify monster material names.
- Did not create new equipment tables.
- Did not add Chapter 06+ placeholder values.
- Did not modify Godot scenes or scripts.

## 2026-06-14 Equipment CBT Quantity Principle

### Added

- Updated `EQUIPMENT_CURRENT.md` with the CBT equipment quantity principle.
- Recorded that CBT equipment count should remain concise.
- Recorded that same-profession same-quality equipment should avoid heavy repetition.
- Recorded that equipment recognizability is higher priority than increasing item count.

### Protected

- Did not modify equipment databases.
- Did not add new equipment items.
- Did not modify monster material names.
- Did not modify Godot scenes or scripts.

## 2026-06-14 Blacksmith Database Chapter 01 Draft

### Added

- Added `BLACKSMITH_DATABASE_CH01.md` as the Chapter 01 Blacksmith Database draft.
- Added Chapter 01 purple equipment structure with 3 broken-equipment purple routes and 3 general purple routes.
- Recorded the Chapter 01 rule that each broken equipment core maps to exactly 1 purple equipment item.
- Recorded purple recipe structure as core material + material A + material B, with a maximum of 3 material slots.
- Used the existing `BROKEN_EQUIPMENT_DATABASE.md` Chapter 01 direction name `邊境獵兵頭盔` for `破損獵兵頭盔`.

### Protected

- Did not modify existing Source of Truth files.
- Did not add monster material names.
- Did not modify broken equipment names.
- Did not modify class trees.
- Did not add final stats, final material quantities, white equipment, green equipment, or blue equipment.
- Did not modify Godot scenes or scripts.

## 2026-06-14 Blacksmith Database Chapter 01 Detail Pass

### Added

- Updated `BLACKSMITH_DATABASE_CH01.md` Chapter 01 purple equipment detail pass.
- Added equipment positioning, fixed effect direction, material structure, and worldbuilding description for 6 purple equipment entries.
- Kept all recipes without final stat values or material quantities.

### Protected

- Did not modify `EQUIPMENT_CURRENT.md`.
- Did not modify `WORKSHOP_CURRENT.md`.
- Did not modify `BROKEN_EQUIPMENT_DATABASE.md`.
- Did not modify `monster_material_master_database.md`.
- Did not add monster material names.
- Did not create white, green, or blue equipment.
- Did not modify Godot scenes or scripts.

## 2026-06-14 Blacksmith Database Chapter 03 Draft

### Added

- Added `BLACKSMITH_DATABASE_CH03.md` as the Chapter 03 purple equipment database draft.
- Added 6 Chapter 03 purple equipment entries: 3 broken-equipment purple routes and 3 general purple routes.
- Recorded Chapter 03 coverage for guard, archer, rogue, apprentice-priest, and mage lines.
- Recorded `黑霧魂墜` as the Chapter 03 all-class accessory route.

### Protected

- Did not create white, green, or blue equipment.
- Did not add final stats or material quantities.
- Did not add monster material names.
- Did not modify existing Source of Truth files.
- Did not modify Godot scenes or scripts.

## 2026-06-14 Blacksmith Database Chapter 05 Draft

### Added

- Added `BLACKSMITH_DATABASE_CH05.md` as the Chapter 05 purple equipment database draft.
- Added 6 Chapter 05 purple equipment route slots: 3 broken-equipment purple routes and 3 general purple route slots pending formal names.
- Recorded Chapter 05 coverage for guard, archer, rogue, apprentice-priest, and mage lines.
- Recorded `聖歌共鳴徽章` as the Chapter 05 all-class accessory route.
...
## 2026-06-14 Blacksmith Database Chapter 05 General Purple Names

### Added

- Updated `BLACKSMITH_DATABASE_CH05.md` with finalized Chapter 05 general purple equipment names.
- Set guard general purple equipment to `聖衛裁決戰甲` with the Sanctum Adjudicator defense / guardian direction.
- Set rogue general purple equipment to `審判密探披風` with the Black-Robed Inquisitor stealth / intelligence direction.
- Set mage general purple equipment to `光輝審判法典` with the Hymn Wraith / Hymn Priest direction.

### Protected

- Did not modify broken-equipment purple routes.
- Did not add final stats or material quantities.
- Did not add monster material names.
- Did not create white, green, or blue equipment.
- Did not modify existing Source of Truth files.
...
## 2026-06-14 Blacksmith Database Chapter 02 Draft

### Added

- Added `BLACKSMITH_DATABASE_CH02.md` as the Chapter 02 purple equipment database draft.
- Added 6 Chapter 02 purple equipment entries: 3 broken-equipment purple routes and 3 general purple routes.
- Recorded Chapter 02 coverage for guard, archer, rogue, apprentice-priest, and mage lines.
- Recorded `裂風羽飾護符` as the Chapter 02 all-class accessory route.
- Recorded SoT name-difference notes for `流亡處刑之刃` and `荒境古核法器` against `BROKEN_EQUIPMENT_DATABASE.md` current product directions.
...
## 2026-06-14 Blacksmith Database Chapter 02 Name Alignment

### Changed

- Updated `BLACKSMITH_DATABASE_CH02.md` to align Chapter 02 broken-purple equipment names with `BROKEN_EQUIPMENT_DATABASE.md`.
- Renamed `流亡處刑之刃` to `處刑者短刃` in the item heading and name field.
- Renamed `荒境古核法器` to `沙核法器` in the item heading and name field.
- Removed the prior SoT name-difference notes for those two entries.

### Protected

- Did not modify `BROKEN_EQUIPMENT_DATABASE.md`.
- Did not modify equipment direction, profession applicability, worldbuilding description, or materials.
- Did not modify existing Source of Truth files.
- Did not add monster material names.
- Did not modify Godot scenes or scripts.

## 2026-06-14 Blacksmith Database Chapter 04 Draft

### Added

- Added `BLACKSMITH_DATABASE_CH04.md` as the Chapter 04 purple equipment database draft.
- Added 6 Chapter 04 purple equipment entries: 3 broken-equipment purple routes and 3 general purple routes.
- Recorded Chapter 04 coverage for guard, archer, rogue, apprentice-priest, and mage lines.
- Recorded `古王秘紋護符` as the Chapter 04 all-class accessory route.
